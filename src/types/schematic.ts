...
export type TileSize = '1x1' | '2x2' | '3x2' | '5x1' | '10x1'; // 2x2 = 2 high, 2 wide; 3x2 = 3 high, 2 wide; 5x1 = 5 wide, 1 high; 10x1 = 10 wide, 1 high
...
export const TILE_SIZES: Record<TileSize, TileSizeConfig> = {
  ...
  '10x1': { cols: 10, rows: 1, label: '10×1 Kachel (10 breit, 1 hoch)', connectionsPerSide: 10 }
};
